      ...
      <Section>
        ...
        <Container className="mt-8 pt-8 border-t">
          <p className="text-sm text-muted-foreground">
            ...
            <br />
            Una empresa de <a href="https://bitcoinargentinagroup.com" target="_blank" rel="noopener noreferrer" className="text-primary underline">Bitcoin Argentina Group</a>.
          </p>
        </Container>
      </Section>
    </footer>
